package se.ecutb.todofullstack.constants.messages;

public class ValidationMessages {
    public static final String USERNAME_FORMAT_MESSAGE = "Specified username is not valid - Must be between 3 and 15 characters and not include @";
